...
if SharedUtils:GetLevelName() ~= 'Levels/XP3_Alborz/XP3_Alborz' or SharedUtils:GetCurrentGameMode() ~= 'GunMaster0' then
        return
    end
	...
	print('Camera base from Alborz Mountains Gunmaster')
...
Vec3(625.833984, 445.231262, 228.500259)
	...
	print('Spawns from Alborz Mountains Gunmaster')
