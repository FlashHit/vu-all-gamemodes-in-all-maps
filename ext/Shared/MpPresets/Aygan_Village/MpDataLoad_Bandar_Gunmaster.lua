    ...
    for i, bundle in pairs(bundles) do
        if bundle == levelName..'_UiPlaying' then
            bundles = {
                ...
                'levels/xp4_rubble/xp4_rubble_uiplaying' -- Replace with the MP level you're using. LEAVE THE _uiplaying AT THE END.
            }
            hook:Pass(bundles,compartment)
        end
    end
	...
	for i, bundle in pairs(bundles) do
        if bundle == levelName..'_UiPreEndOfRound' then
            bundles = {
                ...
                'levels/xp4_rubble/xp4_rubble_uipreendofround' -- Replace with the MP level you're using. LEAVE THE _uiplaying AT THE END.
            }
            hook:Pass(bundles,compartment)
        end
    end
	...
	for i, bundle in pairs(bundles) do
        if bundle == levelName..'_UiEndOfRound' then
            bundles = {
                ...
                'levels/xp4_rubble/xp4_rubble_uiendofround' -- Replace with the MP level you're using. LEAVE THE _uiplaying AT THE END.
            }
            hook:Pass(bundles,compartment)
        end
    end
