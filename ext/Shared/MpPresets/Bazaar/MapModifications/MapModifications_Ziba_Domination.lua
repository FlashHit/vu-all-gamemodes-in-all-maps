...
if SharedUtils:GetLevelName() ~= 'Levels/MP_001/MP_001' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
        return
    end
    ...
    thisInstance.blueprintTransform.trans = Vec3(-10.422852, 85.417038, 70.546730)
	print('Camera base from Bazaar Domination')
...
Vec3(80.015625, 74.024216, 158.945313)
	...
	print('Spawns from Bazaar Domination')
...
if SharedUtils:GetLevelName() ~= 'Levels/MP_001/MP_001' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(-46.003815, 74.161751, 127.001740), Vec3(-59.971081, 74.032379, 126.731628), Vec3(-59.900555, 74.032379, 135.339859), Vec3(-61.207951, 74.032379, 135.374115), Vec3(-61.203770, 74.047600, 144.974136), Vec3(-59.882214, 74.032379, 145.025970), Vec3(-59.902939, 74.049881, 146.370682), Vec3(-51.298897, 74.032379, 146.368927), Vec3(-51.310200, 74.032379, 145.099869), Vec3(-41.062725, 74.032379, 145.099030), Vec3(-41.016468, 74.032379, 144.903183), Vec3(-30.840881, 74.032379, 144.890350), Vec3(-30.577322, 74.300308, 125.369186), Vec3(-45.579994, 74.152611, 125.369179), Vec3(-45.634396, 74.032379, 126.949516)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/MP_001/MP_001' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(-44.950195, 74.033005, 137.030273)
...
if SharedUtils:GetLevelName() ~= 'Levels/MP_001/MP_001' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(-97.900063, 75.461922, 62.719524), Vec3(-98.042511, 75.624786, 82.678101), Vec3(-115.805634, 75.708206, 82.859909), Vec3(-115.926071, 75.507782, 80.020706), Vec3(-128.259857, 75.507782, 79.468712), Vec3(-128.288330, 75.540482, 75.611549), Vec3(-125.750427, 75.507782, 75.572426), Vec3(-126.060478, 75.787407, 75.219910), Vec3(-126.063477, 75.789886, 65.640511), Vec3(-118.420418, 75.787415, 65.664307), Vec3(-118.218811, 75.868286, 62.635536)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/MP_001/MP_001' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(-108.549805, 75.106270, 72.544922)
    thisInstance.blueprintTransform.trans = flagPos
...
if SharedUtils:GetLevelName() ~= 'Levels/MP_001/MP_001' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(-57.707329, 76.752335, -8.929437), Vec3(-57.719913, 76.795876, 11.308547), Vec3(-59.757690, 76.802147, 11.370400), Vec3(-59.706249, 76.755737, 28.932926), Vec3(-65.069138, 76.740120, 28.856766), Vec3(-65.100494, 76.752327, 26.708994), Vec3(-65.675308, 76.817505, 26.639763), Vec3(-65.747269, 76.833244, -13.862345), Vec3(-59.682583, 76.752335, -13.807106), Vec3(-59.642044, 76.752335, -9.102868)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/MP_001/MP_001' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(-62.182617, 76.753716, 2.833008)
    thisInstance.blueprintTransform.trans = flagPos
