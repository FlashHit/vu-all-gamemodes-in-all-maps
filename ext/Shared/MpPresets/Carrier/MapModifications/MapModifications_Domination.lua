...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
        return
    end
...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
	...
	print('Camera base from Carrier Domination')
...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(-1204.535278, 485.843750, 1231.085083), Vec3(-1203.288208, 485.843719, 1255.555420), Vec3(-1180.430054, 485.843719, 1255.807007), Vec3(-1178.732788, 485.843719, 1230.078979)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(-1192.827148, 485.844543, 1246.009766)
...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(-1203.453003, 485.843750, 1068.869751), Vec3(-1225.696533, 485.843719, 1068.598022), Vec3(-1225.809082, 485.843719, 1098.557007), Vec3(-1204.743652, 485.843750, 1103.798462), Vec3(-1196.864380, 485.843750, 1086.243774)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(-1216.435547, 485.893433, 1077.135742)
    thisInstance.blueprintTransform.trans = flagPos
...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(-1171.126099, 485.843719, 1023.972900), Vec3(-1154.879761, 485.843719, 1024.284180), Vec3(-1154.592896, 485.843750, 1020.778625), Vec3(-1152.955811, 485.843719, 1018.933411), Vec3(-1152.913086, 485.843750, 988.424011), Vec3(-1170.771973, 485.843719, 982.446411)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(-1159.804688, 485.844543, 1012.633789)
    thisInstance.blueprintTransform.trans = flagPos
