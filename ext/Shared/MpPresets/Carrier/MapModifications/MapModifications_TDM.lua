...
if SharedUtils:GetLevelName() ~= 'Levels/SP_Jet/SP_Jet' == nil or SharedUtils:GetCurrentGameMode() ~= 'TeamDeathMatch0' and SharedUtils:GetCurrentGameMode() ~= 'TeamDeathMatchC0' then
        return
    end
