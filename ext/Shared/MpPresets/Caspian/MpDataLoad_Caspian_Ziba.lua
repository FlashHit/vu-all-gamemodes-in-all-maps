...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'MP_007') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    -- Exchanging Caspian materialGrid with XP5_002 materialGrid
