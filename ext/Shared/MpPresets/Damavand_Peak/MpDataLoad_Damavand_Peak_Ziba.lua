...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'MP_013') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
Hooks:Install('ResourceManager:LoadBundles', 500, function(hook, bundles, compartment)
    ...
    -- This is so your preset only loads when the SP/COOP level and gamemode you want is loading.
    -- PLEASE don't use the TeamDeathMatchC0 gamemode. It is reserved for this (default) preset for exploration.
    if string.find(levelName, 'MP_013') == nil or gameModeName ~= 'CaptureTheFlag0' then
        return
    end
...
-- Damavand Peak
ResourceManager:RegisterInstanceLoadHandler(Guid('AF047CB6-17E4-CF77-3DC3-68D5241DA68F'), Guid('AF047CB6-17E4-CF77-3DC3-68D5241DA68F'), function(instance)
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    -- Exchanging Seine Crosing materialGrid with XP5_002 materialGrid
    p_LevelData.runtimeMaterialGrid = MaterialGridData(ResourceManager:FindInstanceByGuid(Guid('5CF190FB-D52E-82E2-27E5-5E68F3ADE7CD'), Guid('0A160D5A-31B5-A70B-5F23-3B0AAD229C0A')))
