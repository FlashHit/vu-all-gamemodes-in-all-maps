...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'XP3_Valley') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
Hooks:Install('ResourceManager:LoadBundles', 500, function(hook, bundles, compartment)
    ...
    -- This is so your preset only loads when the SP/COOP level and gamemode you want is loading.
    -- PLEASE don't use the TeamDeathMatchC0 gamemode. It is reserved for this (default) preset for exploration.
    if string.find(levelName, 'XP3_Valley') == nil or gameModeName ~= 'CaptureTheFlag0' then
        return
    end
...
-- Death Valley
ResourceManager:RegisterInstanceLoadHandler(Guid('5E5F16E0-BDFE-C215-15A0-E633DD76BDD2'), Guid('5E5F16E0-BDFE-C215-15A0-E633DD76BDD2'), function(instance)
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    -- Exchanging Death Valley Grid with XP5_002 materialGrid
