...
if SharedUtils:GetLevelName() ~= 'Levels/XP2_Palace/XP2_Palace' or SharedUtils:GetCurrentGameMode() ~= 'AirSuperiority0' then
        return
    else
end
...
-- Donya Fortress
ResourceManager:RegisterInstanceLoadHandler(Guid('83064A78-DA25-F9FC-05AE-D6F847FCCA24'), Guid('83064A78-DA25-F9FC-05AE-D6F847FCCA24'), function(instance)
