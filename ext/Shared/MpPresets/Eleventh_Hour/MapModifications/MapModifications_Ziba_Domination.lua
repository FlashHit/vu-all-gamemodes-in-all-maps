...
if SharedUtils:GetLevelName() ~= 'Levels/COOP_002/COOP_002' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
        return
    end
    ...
    thisInstance.blueprintTransform.trans = Vec3(10.573242, -5.653125, 99.917969)
	print('Camera base from Hit and Run Domination')
...
Vec3(-12.444336, 0.820127, 26.573242)
	...
	print('Spawns from Hit and Run Domination')
...
if SharedUtils:GetLevelName() ~= 'Levels/COOP_002/COOP_002' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(35.105244, 10.441219, 112.478958), Vec3(6.660250, 10.427934, 112.478958), Vec3(6.681009, 10.422398, 92.467621), Vec3(16.181606, 10.616285, 92.432724), Vec3(16.181614, 10.524180, 83.266045), Vec3(35.330963, 10.422396, 83.196800)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/COOP_002/COOP_002' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(22.015625, 10.421701, 99.703125)
    thisInstance.blueprintTransform.trans = flagPos
...
if SharedUtils:GetLevelName() ~= 'Levels/COOP_002/COOP_002' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(16.375559, 1.460272, 92.539772), Vec3(53.209187, 1.460270, 92.572021), Vec3(53.309017, 1.460270, 105.981529), Vec3(16.486555, 1.460272, 105.985130)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/COOP_002/COOP_002' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(18.517578, 1.460742, 95.788086)
    thisInstance.blueprintTransform.trans = flagPos
