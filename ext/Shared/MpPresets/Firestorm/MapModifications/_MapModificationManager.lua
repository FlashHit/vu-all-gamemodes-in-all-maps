...
Events:Subscribe('Level:LoadResources', function()
    ...
    if string.find(levelName, 'MP_012') and gameModeName == 'Domination0' then
...
Events:Subscribe('Level:LoadResources', function()
    ...
    -- Don't continue if the level is not Operation Firestorm
    if string.find(levelName, 'MP_012') and gameModeName == 'CaptureTheFlag0' then
     

    print('Initialising Operation Firestorm CaptureTheFlag scripts...')

    require '__shared/MpPresets/Firestorm/MapModifications/CaptureTheFlag'
	else
	return
	end
