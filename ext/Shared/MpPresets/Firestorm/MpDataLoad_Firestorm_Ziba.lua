...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'MP_012') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
-- Operation Firestorm
ResourceManager:RegisterInstanceLoadHandler(Guid('1B613A98-BDD5-DBF7-6314-820A836DAA41'), Guid('1B613A98-BDD5-DBF7-6314-820A836DAA41'), function(instance)
