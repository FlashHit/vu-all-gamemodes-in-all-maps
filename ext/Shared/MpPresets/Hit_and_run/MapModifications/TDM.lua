...
if SharedUtils:GetLevelName() ~= 'Levels/COOP_002/COOP_002' or SharedUtils:GetCurrentGameMode() ~= 'TeamDeathMatchC0' then
        return
    end

    local thisInstance = ReferenceObjectData(instance)
    thisInstance:MakeWritable()
    thisInstance.blueprintTransform.trans = Vec3(-50.573242, -5.653125, 110.917969)
	print('Camera base from Hit and Run TDM')

end)

------------------------------------
--Camera Base Spawn for Squad TDM --
------------------------------------
...
if SharedUtils:GetLevelName() ~= 'Levels/COOP_002/COOP_002' or SharedUtils:GetCurrentGameMode() ~= 'SquadDeathMatch0' then
        return
    end

    local thisInstance = ReferenceObjectData(instance)
    thisInstance:MakeWritable()
    thisInstance.blueprintTransform.trans = Vec3(-50.573242, 15.653125, 110.917969)
	print('Camera base from Hit and Run SQDM')
...
if SharedUtils:GetLevelName() ~= 'Levels/COOP_002/COOP_002'or SharedUtils:GetCurrentGameMode() ~= 'SquadDeathMatch0' and SharedUtils:GetCurrentGameMode() ~= 'TeamDeathMatchC0' then
        return
    end
...
Vec3(-12.444336, 0.820127, 26.573242)
	...
	print('Spawns from Hit and Run TDM')
