...
-- Strike at Karkand
ResourceManager:RegisterInstanceLoadHandler(Guid('B048FCB3-CF34-B3CF-4EDC-730B3EBD1034'), Guid('B048FCB3-CF34-B3CF-4EDC-730B3EBD1034'), function(instance)
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    -- Exchanging Karkand materialGrid with XP5_004 materialGrid
