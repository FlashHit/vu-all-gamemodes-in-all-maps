...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'MP_018') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
Hooks:Install('ResourceManager:LoadBundles', 500, function(hook, bundles, compartment)
    ...
    -- This is so your preset only loads when the SP/COOP level and gamemode you want is loading.
    -- PLEASE don't use the TeamDeathMatchC0 gamemode. It is reserved for this (default) preset for exploration.
    if string.find(levelName, 'MP_018') == nil or gameModeName ~= 'CaptureTheFlag0' then
        return
    end
...
-- Kharg Island
ResourceManager:RegisterInstanceLoadHandler(Guid('688FF05C-006A-9061-C68F-431F0954AAE9'), Guid('688FF05C-006A-9061-C68F-431F0954AAE9'), function(instance)
