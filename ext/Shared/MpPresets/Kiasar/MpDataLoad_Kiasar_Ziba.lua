...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'XP5_003') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
-- Kiasar Railroad
ResourceManager:RegisterInstanceLoadHandler(Guid('507BBACE-C7D1-38E9-875B-0021D99595C3'), Guid('507BBACE-C7D1-38E9-875B-0021D99595C3'), function(instance)
