...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'XP5_002') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
-- Nebandan Flats
ResourceManager:RegisterInstanceLoadHandler(Guid('8BDDE9BC-F9E6-63C0-0AF8-57008422C053'), Guid('8BDDE9BC-F9E6-63C0-0AF8-57008422C053'), function(instance)
