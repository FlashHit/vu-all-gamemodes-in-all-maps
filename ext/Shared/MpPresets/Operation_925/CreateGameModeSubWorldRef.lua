...
-- In a nutshell, for multiplayer maps, different gamemodes are different subworlds, each referenced in the main level partition (e.g. Levels/XP2_Office/XP2_Office).
-- This script clones the SubWorldReferenceObjectData from the XP2_Office main level partition, and adds it to the singleplayer/co-op map being loaded.
