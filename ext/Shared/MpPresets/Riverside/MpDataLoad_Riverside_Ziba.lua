...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'XP5_001') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
-- Operation Riverside
ResourceManager:RegisterInstanceLoadHandler(Guid('15C054A9-E36E-6BF5-C210-AE265D0CFF6A'), Guid('15C054A9-E36E-6BF5-C210-AE265D0CFF6A'), function(instance)
