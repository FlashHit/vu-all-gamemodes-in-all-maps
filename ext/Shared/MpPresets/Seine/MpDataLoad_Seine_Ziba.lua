...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'MP_011') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
Hooks:Install('ResourceManager:LoadBundles', 500, function(hook, bundles, compartment)
    ...
    -- This is so your preset only loads when the SP/COOP level and gamemode you want is loading.
    -- PLEASE don't use the TeamDeathMatchC0 gamemode. It is reserved for this (default) preset for exploration.
    if string.find(levelName, 'MP_011') == nil or gameModeName ~= 'CaptureTheFlag0' then
        return
    end
...
-- Seine Crossing
ResourceManager:RegisterInstanceLoadHandler(Guid('BF61465F-6C86-DB40-F838-D9E6127F76BE'), Guid('BF61465F-6C86-DB40-F838-D9E6127F76BE'), function(instance)
