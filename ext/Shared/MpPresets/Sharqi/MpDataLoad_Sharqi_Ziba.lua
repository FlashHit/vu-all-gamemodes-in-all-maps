...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'XP1_003') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
Hooks:Install('ResourceManager:LoadBundles', 500, function(hook, bundles, compartment)
    ...
    -- This is so your preset only loads when the SP/COOP level and gamemode you want is loading.
    -- PLEASE don't use the TeamDeathMatchC0 gamemode. It is reserved for this (default) preset for exploration.
    if string.find(levelName, 'XP1_003') == nil or gameModeName ~= 'CaptureTheFlag0' then
        return
    end
...
-- Sharqi Peninsula
ResourceManager:RegisterInstanceLoadHandler(Guid('F9C5AA47-3B87-A77A-14D3-3D779310D1C3'), Guid('F9C5AA47-3B87-A77A-14D3-3D779310D1C3'), function(instance)
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    -- Exchanging Sharqi materialGrid with XP5_004 materialGrid
