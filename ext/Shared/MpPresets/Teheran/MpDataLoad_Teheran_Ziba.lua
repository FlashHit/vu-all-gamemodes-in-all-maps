...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'MP_003') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
Hooks:Install('ResourceManager:LoadBundles', 500, function(hook, bundles, compartment)
    ...
    -- This is so your preset only loads when the SP/COOP level and gamemode you want is loading.
    -- PLEASE don't use the TeamDeathMatchC0 gamemode. It is reserved for this (default) preset for exploration.
    if string.find(levelName, 'MP_003') == nil or gameModeName ~= 'CaptureTheFlag0' then
        return
    end
...
-- Teheran Highway
ResourceManager:RegisterInstanceLoadHandler(Guid('2A290D42-F543-40B0-1132-940F8F791C80'), Guid('2A290D42-F543-40B0-1132-940F8F791C80'), function(instance)
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    -- Exchanging Teheran materialGrid with XP5_002 materialGrid
