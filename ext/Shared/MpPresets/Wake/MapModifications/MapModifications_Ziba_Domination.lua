...
if SharedUtils:GetLevelName() ~= 'Levels/XP1_004/XP1_004' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
        return
    end
	...
	print('Camera base from Wake Island Domination')
...
Vec3(276.699219, 96.773239, 71.291992)
	...
	print('Spawns from Wake Island Domination')
...
if SharedUtils:GetLevelName() ~= 'Levels/XP1_004/XP1_004' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(367.724030, 116.826508, 297.398865), Vec3(351.932098, 116.826508, 317.712708), Vec3(372.427643, 116.826500, 333.716522), Vec3(388.417023, 116.826508, 313.608978)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/XP1_004/XP1_004' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(371.653320, 116.826950, 314.924805)
...
if SharedUtils:GetLevelName() ~= 'Levels/XP1_004/XP1_004' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(309.894562, 116.622337, 225.498611), Vec3(309.783142, 116.622337, 224.816360), Vec3(310.450867, 116.622337, 221.864822), Vec3(312.179565, 116.622330, 217.852997), Vec3(314.701599, 116.622330, 214.242905), Vec3(317.684204, 116.622330, 211.141464), Vec3(320.115112, 116.622337, 209.417374), Vec3(320.835602, 116.622337, 209.349670), Vec3(342.951843, 116.622330, 224.210236), Vec3(331.817474, 116.622330, 240.466125)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/XP1_004/XP1_004' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(318.694336, 116.622849, 221.179688)
    thisInstance.blueprintTransform.trans = flagPos
...
if SharedUtils:GetLevelName() ~= 'Levels/XP1_004/XP1_004' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local points = {
        Vec3(354.838745, 116.692627, 130.619522), Vec3(354.623718, 117.175453, 141.155182), Vec3(354.931213, 116.692039, 149.927490), Vec3(355.068512, 116.779160, 162.813187), Vec3(342.363007, 116.899811, 162.847824), Vec3(333.791107, 116.725708, 156.225937), Vec3(330.132477, 116.829720, 155.089355), Vec3(330.508942, 116.708549, 138.428223), Vec3(331.711731, 116.211533, 135.151642), Vec3(336.203918, 116.406021, 132.587387), Vec3(337.907990, 116.425819, 130.441025)
    }
...
if SharedUtils:GetLevelName() ~= 'Levels/XP1_004/XP1_004' or SharedUtils:GetCurrentGameMode() ~= 'Domination0' then
    ...
    local flagPos = Vec3(344.331055, 116.675613, 138.595703)
    thisInstance.blueprintTransform.trans = flagPos
