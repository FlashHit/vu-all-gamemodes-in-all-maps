...
Events:Subscribe('Level:LoadResources', function()
	...
	if string.find(levelName, 'XP1_004') == nil or gameModeName ~= 'Domination0' and gameModeName ~= 'GunMaster0' then 
	        return
    end
...
Hooks:Install('ResourceManager:LoadBundles', 500, function(hook, bundles, compartment)
    ...
    -- This is so your preset only loads when the SP/COOP level and gamemode you want is loading.
    -- PLEASE don't use the TeamDeathMatchC0 gamemode. It is reserved for this (default) preset for exploration.
    if string.find(levelName, 'XP1_004') == nil or gameModeName ~= 'CaptureTheFlag0' then
        return
    end
...
-- Wake Island
ResourceManager:RegisterInstanceLoadHandler(Guid('FFE6184F-70FE-8333-819C-B89DD94A03EB'), Guid('FFE6184F-70FE-8333-819C-B89DD94A03EB'), function(instance)
